package com.krpvn.shoppinglist.data
...
import com.krpvn.shoppinglist.presentation.ShopApplication
...
class ShopListProvider : ContentProvider() {
    ...
    private val uriMatcher = UriMatcher(UriMatcher.NO_MATCH).apply {
        addURI("com.krpvn.shoppinglist", "shop_items", GET_SHOP_ITEMS_QUERY)
        addURI("com.krpvn.shoppinglist", "shop_items/#", GET_SHOP_ITEM_BY_ID_QUERY)
    }
